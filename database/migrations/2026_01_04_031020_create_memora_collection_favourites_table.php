...
return new class extends Migration
{
    ...
    {
        Schema::create('memora_collection_favourites', static function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['collection_uuid', 'media_uuid']);
    ...
    {
        Schema::dropIfExists('memora_collection_favourites');
    }
};
